...
from ._exceptions import TestAPIError, APIStatusError
...
__all__ = ["Timeout", "Transport", "ProxiesTypes", "RequestOptions", "TestAPI", "AsyncTestAPI", "Client", "AsyncClient"]


class TestAPI(SyncAPIClient):
    __test__ = False
    pets: pets.PetsResource
    store: store.StoreResource
    user: user.UserResource
    with_raw_response: TestAPIWithRawResponse
    with_streaming_response: TestAPIWithStreamedResponse
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new synchronous TestAPI client instance.
        ...
        self.with_raw_response = TestAPIWithRawResponse(self)
        self.with_streaming_response = TestAPIWithStreamedResponse(self)
...
class AsyncTestAPI(AsyncAPIClient):
    pets: pets.AsyncPetsResource
    store: store.AsyncStoreResource
    user: user.AsyncUserResource
    with_raw_response: AsyncTestAPIWithRawResponse
    with_streaming_response: AsyncTestAPIWithStreamedResponse
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new async AsyncTestAPI client instance.
        ...
        self.with_raw_response = AsyncTestAPIWithRawResponse(self)
        self.with_streaming_response = AsyncTestAPIWithStreamedResponse(self)
...
class TestAPIWithRawResponse:
    __test__ = False

    def __init__(self, client: TestAPI) -> None:
...
class AsyncTestAPIWithRawResponse:
    def __init__(self, client: AsyncTestAPI) -> None:
...
class TestAPIWithStreamedResponse:
    __test__ = False
...
class AsyncTestAPIWithStreamedResponse:
    def __init__(self, client: AsyncTestAPI) -> None:
